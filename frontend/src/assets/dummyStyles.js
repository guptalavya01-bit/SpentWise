...
export const dashboardStyles = {
  ...
  // Header styles
  headerContainer: "bg-gradient-to-r from-purple-500/10 to-violet-500/10 backdrop-blur-lg rounded-3xl p-6 mb-8 shadow-lg border border-white/30",
  headerContent: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8",
  headerTitle: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 to-violet-700 bg-clip-text text-transparent",
  headerSubtitle: "text-gray-600 mt-2",
  
  // Button styles
  addButton: "flex items-center gap-2 bg-purple-500 hover:bg-purple-600 text-white px-5 py-3 rounded-xl transition-all shadow hover:shadow-md font-medium",
  ...
  balanceBadge: "bg-purple-100 text-purple-800 px-2 py-1 rounded-lg text-xs",
  ...
  viewAllButton: "w-full flex items-center justify-center gap-2 py-3 text-purple-600 font-medium hover:bg-purple-50 rounded-xl transition-colors",
  
  // Icon container styles
  iconContainer: (color) => `p-2 ${color} rounded-lg`,
  
  // Specific icon colors
  walletIconContainer: "p-2 bg-purple-100 rounded-lg",
  arrowDownIconContainer: "p-2 bg-orange-100 rounded-lg",
  piggyBankIconContainer: "p-2 bg-violet-100 rounded-lg",
};
...
export const trendStyles = {
  ...
  positiveRate: "bg-purple-100 text-purple-700",
...
export const incomeStyles = {
  ...
  filterSelect: "appearance-none bg-white border border-gray-300 rounded-lg pl-3 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent w-full",
...
export const profileStyles = {
  ...
  // Header styles
  header: "bg-gradient-to-r from-purple-500 to-violet-600 p-8 text-center",
  ...
  userEmail: "text-purple-100 mt-2",
  ...
  icon: "w-5 h-5 mr-2 text-purple-600",
  
  // Form styles
  label: "text-sm text-gray-500  block mb-1",
  input: "w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  inputWithError: "w-full px-4 py-2 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  
  // Button styles
  buttonPrimary: "flex-1 bg-gradient-to-r from-purple-500 to-violet-600 text-white py-2.5 rounded-xl font-medium shadow-md",
  buttonSecondary: "flex-1 py-2.5 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-100",
  editButton: "text-purple-600 hover:text-purple-700 font-medium text-sm",
  changeButton: "text-purple-600 hover:text-purple-700 font-medium lg:text-sm",
...
export const modalStyles = {
  ...
  colorClasses: {
    purple: {
      ...
      typeButtonSelected: "bg-purple-500",
    },
    orange: {
...
export const loginStyles = {
  // Page container
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-50 to-violet-50",
  
  // Card container
  cardContainer: "w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-purple-500 to-violet-600 p-6 text-center",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-purple-100 mt-2",
  ...
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  
  // Checkbox
  checkboxContainer: "mb-6 flex items-center",
  checkbox: "w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500",
  checkboxLabel: "ml-2 block text-sm text-gray-700",
  
  // Button
  button: "w-full bg-gradient-to-r from-purple-500 to-violet-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
  buttonDisabled: "opacity-80 cursor-not-allowed",
  
  // Sign up link
  signUpContainer: "mt-8 text-center",
  signUpText: "text-gray-600",
  signUpLink: "font-medium text-purple-600 hover:underline",
...
export const navbarStyles = {
  ...
  userAvatar: "w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-600 to-violet-500 text-white font-bold text-lg",
  ...
  dropdownAvatar: "w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-violet-500 flex items-center justify-center text-white font-bold text-lg",
...
export const signupStyles = {
  ...
  header: "bg-gradient-to-r from-purple-500 to-violet-600 p-6 text-center relative",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-purple-100 mt-2",
  ...
  inputContainer: "relative",
  inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-purple-300 focus:border-purple-500",
  passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  signInLink: "font-medium text-purple-600 hover:underline",
...
export const sidebarStyles = {
  ...
  userInitials: {
    base: "w-12 h-12 rounded-xl bg-gradient-to-br from-purple-400 to-violet-500 flex items-center justify-center text-white font-bold text-xl"
  },
  ...
  menuItem: {
    ...
    inactive: "text-gray-600 hover:text-purple-700 hover:bg-gray-50",
  ...
  activeIndicator: "absolute right-4 w-2 h-2 bg-purple-400 rounded-full animate-ping",
  
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-500 hover:text-purple-600 hover:border-purple-400 hover:bg-purple-50 transition-all"
  },
  ...
  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 hover:text-purple-700 hover:bg-gray-50",
  ...
  mobileFooterLink: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-purple-700",
  mobileLogoutButton: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-red-600 w-full",
  
  // Mobile menu button
  mobileMenuButton: "lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-br from-purple-500 to-violet-600 text-white rounded-full flex items-center justify-center shadow-xl"
};
...
export const styles = {
  ...
  transactions: {
    ...
    dataStackingInfo: "flex items-center gap-2 text-xs text-gray-500 mb-4 bg-purple-50 p-2 rounded-lg",
    dataStackingIcon: "w-4 h-4 text-purple-500",
    ...
    iconWrapper: (type) => type === 'income' ? 'bg-purple-100 text-purple-600' : 'bg-orange-100 text-orange-600',
    icon: "w-4 h-4",
    details: "min-w-0",
    description: "font-medium text-gray-800 truncate max-w-[120px]",
    meta: "text-xs text-gray-500 mt-1",
    amount: (type) => `font-semibold ${type === 'income' ? 'text-purple-600' : 'text-orange-600'}`,
    emptyState: "text-center py-8",
  ...
  categories: {
    ...
    titleIcon: "w-6 h-6 text-violet-500",
    list: "space-y-4",
    ...
    summaryIncomeCard: "bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-4",
  ...
  colors: {
    transaction: {
      text: (type) => type === 'income' ? 'text-purple-600' : 'text-orange-600',
      bg: (type) => type === 'income' ? 'bg-purple-100 text-purple-600' : 'bg-orange-100 text-orange-600',
    },
